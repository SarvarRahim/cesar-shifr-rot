...
const elClearBtn = elForm.querySelector('.js-btn-clear');
const elCopyBtn = elForm.querySelector('.js-btn-copy');
...
function doDecrytp (ent) {
  ent.preventDefault();
  elFormTexareaInput.value = doDecrytp(elFormTexareaOutput.value, Number(elRotate.value));
}
elFormTexareaOutput.addEventListener('keyup', doDecrytp);

if (elClearBtn) {
  elClearBtn.addEventListener('click', () => {
    elFormTexareaInput.innerHTML = '';
    elFormTexareaOutput.innerHTML = '';
  })
}

elCopyBtn.addEventListener('click', () => {
  elFormTexareaOutput.select();
