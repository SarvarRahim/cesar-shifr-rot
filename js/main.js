...
//     elFormTexareaOutput.value = rot(elFormTexareaInput.value, Number(elRotate.value));
//   }
//   elFormTexareaInput.addEventListener('keyup', rot);

//   function doDecrytp (evt) {
//     evt.preventDefault();
//     elFormTexareaInput.value = decrypt(elFormTexareaOutput.value, Number(elRotate.value));
//   }
//   elFormTexareaOutput.addEventListener('keyup', decrypt);